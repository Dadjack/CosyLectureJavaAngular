package com.projet.library.datacreation;
...
public class CountriesList {
    public static void main(String[] args) {
        String[] countries = {
                ...
                "Chili", "Chine", "Chypre", "Colombie", "Comores", "Congo (Congo-Brazzaville)", "Costa Rica",
                "Croatie", "Cuba", "Danemark", "Djibouti", "Dominique", "Égypte", "Émirats arabes unis",
                "Équateur", "Érythrée", "Espagne", "Estonie", "Eswatini", "Éthiopie", "Fidji", "Finlande",
                ...
                "Saint-Kitts-et-Nevis", "Sainte-Lucie", "Saint-Marin", "Saint-Vincent-et-les Grenadines", "Salomon",
        ...
        System.out.println("Quelques pays :");
        for (int i = 0; i < 5; i++) {
